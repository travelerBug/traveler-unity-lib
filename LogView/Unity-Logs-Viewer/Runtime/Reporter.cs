...
public class Reporter : MonoBehaviour
{
    ...
    private float mTopArea;

    void OnEnable()
    {
        var safeArea = Screen.safeArea;
        // float safeAreaTopY = safeArea.y + safeArea.height;
        // mTopArea = Screen.height-safeAreaTopY;
        mTopArea = safeArea.y;
    ...
    public void OnGUIDraw()
    {
        ...
        // GUILayout.Space(Screen.safeArea.size.y);
